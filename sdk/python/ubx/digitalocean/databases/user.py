...
@dataclasses.dataclass
class User_Settings_Acl:
    id: Any = None
    permission: Any = None
    topic: Any = None

@dataclasses.dataclass
class User_Settings_MongoUserSettings:
...
@dataclasses.dataclass
class User_Settings_OpensearchAcl:
    index: Any = None
    permission: Any = None
...
_User_MysqlSettingsFields = {
    "auth_plugin": ubx.FieldSpec(wire_name="auth_plugin"),
}

_User_Settings_AclFields = {
    "id": ubx.FieldSpec(wire_name="id"),
    "permission": ubx.FieldSpec(wire_name="permission"),
    "topic": ubx.FieldSpec(wire_name="topic"),
}

_User_Settings_MongoUserSettingsFields = {
    "databases": ubx.FieldSpec(wire_name="databases"),
    "role": ubx.FieldSpec(wire_name="role"),
}

_User_Settings_OpensearchAclFields = {
    "index": ubx.FieldSpec(wire_name="index"),
    "permission": ubx.FieldSpec(wire_name="permission"),
}

_User_SettingsFields = {
    "acl": ubx.FieldSpec(
        wire_name="acl",
        kind="list",
        fields=_User_Settings_AclFields,
    ),
    "mongo_user_settings": ubx.FieldSpec(
        wire_name="mongo_user_settings",
        kind="object",
        fields=_User_Settings_MongoUserSettingsFields,
    ),
    "opensearch_acl": ubx.FieldSpec(
        wire_name="opensearch_acl",
        kind="list",
        fields=_User_Settings_OpensearchAclFields,
    ),
    "pg_allow_replication": ubx.FieldSpec(wire_name="pg_allow_replication"),
}
...
User = ubx.ResourceBinding(
    ...
    fields={
        "mysql_settings": ubx.FieldSpec(
            ...
            kind="object",
            fields=_User_MysqlSettingsFields,
        ),
        "name": ubx.FieldSpec(wire_name="name"),
        "readonly": ubx.FieldSpec(wire_name="readonly"),
        "settings": ubx.FieldSpec(
            wire_name="settings",
            kind="object",
            fields=_User_SettingsFields,
        ),
