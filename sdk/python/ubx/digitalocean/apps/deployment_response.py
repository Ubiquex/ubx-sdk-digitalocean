...
class DeploymentResponse_Deployment_Functions:
    name: Any = None
    namespace: Any = None
    source_commit_hash: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Jobs:
    name: Any = None
    source_commit_hash: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Progress_Steps_Reason:
    code: Any = None
    message: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Progress_Steps:
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Progress:
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Databases:
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Domains:
    domain: Any = None
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Egress:
    type: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Functions_Alerts:
    disabled: Any = None
    operator: Any = None
    rule: Any = None
    value: Any = None
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Functions_Bitbucket:
    branch: Any = None
    deploy_on_push: Any = None
    repo: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Functions_Cors_AllowOrigins:
    exact: Any = None
    prefix: Any = None
    regex: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Functions_Cors:
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Functions_Envs:
    key: Any = None
    scope: Any = None
    type: Any = None
    value: Any = None
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Functions_Git:
    branch: Any = None
    repo_clone_url: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Functions_LogDestinations_Datadog:
    api_key: Any = None
    endpoint: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Functions_LogDestinations_Logtail:
    token: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Functions_LogDestinations_OpenSearch_BasicAuth:
    password: Any = None
    user: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Functions_LogDestinations_OpenSearch:
    basic_auth: Any = None
    cluster_name: Any = None
    endpoint: Any = None
    index_name: Any = None
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Functions_LogDestinations_Papertrail:
    endpoint: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Functions_LogDestinations:
    datadog: Any = None
    logtail: Any = None
    name: Any = None
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Functions_Routes:
    path: Any = None
    preserve_path_prefix: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Functions:
    alerts: Any = None
    bitbucket: Any = None
    cors: Any = None
    envs: Any = None
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Ingress_Rules_Component:
    name: Any = None
    preserve_path_prefix: Any = None
    rewrite: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Ingress_Rules_Match_Authority:
    exact: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Ingress_Rules_Match_Path:
    prefix: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Ingress_Rules_Match:
    authority: Any = None
    path: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Ingress_Rules_Redirect:
    authority: Any = None
    port: Any = None
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Ingress_Rules:
    component: Any = None
    cors: Any = None
    match: Any = None
    redirect: Any = None
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Ingress:
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Jobs_Image_DeployOnPush:
    enabled: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Jobs_Image:
    deploy_on_push: Any = None
    digest: Any = None
    registry: Any = None
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Jobs_Termination:
    grace_period_seconds: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Jobs:
    bitbucket: Any = None
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Maintenance:
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Services_Autoscaling_Metrics_RequestDuration:
    p95_milliseconds: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Services_Autoscaling_Metrics_RequestsPerSecond:
    per_instance: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Services_Autoscaling_Metrics:
    request_duration: Any = None
    requests_per_second: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Services_Autoscaling:
    max_instance_count: Any = None
    metrics: Any = None
    min_instance_count: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Services_HealthCheck:
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Services_Termination:
    drain_seconds: Any = None
    grace_period_seconds: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Services:
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_StaticSites:
    bitbucket: Any = None
    build_command: Any = None
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Vpc_EgressIps:
    ip: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Vpc:
    egress_ips: Any = None
    id: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Workers_Autoscaling_Metrics_Cpu:
    percent: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Workers_Autoscaling_Metrics:
    cpu: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Workers_Autoscaling:
    max_instance_count: Any = None
    metrics: Any = None
    min_instance_count: Any = None

@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec_Workers:
    autoscaling: Any = None
    bitbucket: Any = None
    build_command: Any = None
    dockerfile_path: Any = None
...
@dataclasses.dataclass
class DeploymentResponse_Deployment_Spec:
...
@dataclasses.dataclass
class DeploymentResponse_Deployment:
    cause: Any = None
...
DeploymentResponse = ubx.ResourceBinding(
    wire_type="digitalocean_apps_deployment_response",
    fields={
        "force_build": ubx.FieldSpec(wire_name="force_build"),
