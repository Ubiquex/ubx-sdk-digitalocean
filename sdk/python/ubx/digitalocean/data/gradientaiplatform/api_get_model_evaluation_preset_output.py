...
class ApiGetModelEvaluationPresetOutput_Preset_CandidateInferenceConfig:
    max_tokens: Any = None
    stop_token: Any = None
...
@dataclasses.dataclass
class ApiGetModelEvaluationPresetOutput_Preset_Metrics_AssociatedPresets:
    eval_preset_uuid: Any = None
    name: Any = None

@dataclasses.dataclass
class ApiGetModelEvaluationPresetOutput_Preset_Metrics_CustomEvalConfig:
    created_at: Any = None
    deleted_at: Any = None
...
@dataclasses.dataclass
class ApiGetModelEvaluationPresetOutput_Preset_Metrics:
...
@dataclasses.dataclass
class ApiGetModelEvaluationPresetOutput_Preset_StarMetric:
    metric_uuid: Any = None
    name: Any = None
...
@dataclasses.dataclass
class ApiGetModelEvaluationPresetOutput_Preset:
...
@dataclasses.dataclass
class ApiGetModelEvaluationPresetOutputConfig:
    eval_preset_uuid: Any = None

@dataclasses.dataclass
class ApiGetModelEvaluationPresetOutputAttrs:
    eval_preset_uuid: Any = None
...
ApiGetModelEvaluationPresetOutput = ubx.DataSourceBinding(
