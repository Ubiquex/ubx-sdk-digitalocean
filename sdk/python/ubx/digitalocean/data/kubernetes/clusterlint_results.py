...
class ClusterlintResults_Diagnostics_Object:
    kind: Any = None
    name: Any = None
    namespace: Any = None

@dataclasses.dataclass
class ClusterlintResults_Diagnostics:
    check_name: Any = None
    message: Any = None
    object: Any = None
    severity: Any = None
...
@dataclasses.dataclass
class ClusterlintResultsConfig:
    cluster_id: Any = None
    run_id: Any = None

@dataclasses.dataclass
class ClusterlintResultsAttrs:
    cluster_id: Any = None
...
ClusterlintResults = ubx.DataSourceBinding(
