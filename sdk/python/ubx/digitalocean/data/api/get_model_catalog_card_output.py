...
class GetModelCatalogCardOutput_Data_CodeSnippets:
    curl: Any = None
    javascript: Any = None
    python: Any = None
    sdk: Any = None
...
@dataclasses.dataclass
class GetModelCatalogCardOutput_Data_Modalities:
    input: Any = None
    output: Any = None

@dataclasses.dataclass
class GetModelCatalogCardOutput_Data_Pricing:
...
@dataclasses.dataclass
class GetModelCatalogCardOutput_Data_PricingDetail_Variants_ScaledPricing_Intervals:
    end_time: Any = None
    prices: Any = None
    start_time: Any = None

@dataclasses.dataclass
class GetModelCatalogCardOutput_Data_PricingDetail_Variants_ScaledPricing:
    intervals: Any = None
    max_prices: Any = None
    min_prices: Any = None

@dataclasses.dataclass
class GetModelCatalogCardOutput_Data_PricingDetail_Variants:
    currency: Any = None
    label: Any = None
    mode: Any = None
    prices: Any = None
...
@dataclasses.dataclass
class GetModelCatalogCardOutput_Data_PricingDetail:
    # Each available pricing variant for the model.
    variants: Any = None

@dataclasses.dataclass
class GetModelCatalogCardOutput_Data:
...
@dataclasses.dataclass
class GetModelCatalogCardOutputConfig:
    id: Any = None
    model_id: Any = None

@dataclasses.dataclass
class GetModelCatalogCardOutputAttrs:
    # Detail view for GetModelCatalogCard
    data: Any = None
    id: Any = None
    model_id: Any = None

GetModelCatalogCardOutput = ubx.DataSourceBinding(
