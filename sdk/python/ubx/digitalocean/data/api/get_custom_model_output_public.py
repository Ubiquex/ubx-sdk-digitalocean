...
class GetCustomModelOutputPublic_Model_ActiveDeployments_Endpoints:
    private_endpoint_fqdn: Any = None
    public_endpoint_fqdn: Any = None

@dataclasses.dataclass
class GetCustomModelOutputPublic_Model_ActiveDeployments:
    created_at: Any = None
    endpoints: Any = None
    id: Any = None
    name: Any = None
...
@dataclasses.dataclass
class GetCustomModelOutputPublic_Model_SourceRef:
...
@dataclasses.dataclass
class GetCustomModelOutputPublic_Model_Tags:
    # List of tag strings
    tags: Any = None

@dataclasses.dataclass
class GetCustomModelOutputPublic_Model:
...
@dataclasses.dataclass
class GetCustomModelOutputPublicConfig:
    uuid: Any = None

@dataclasses.dataclass
class GetCustomModelOutputPublicAttrs:
    # Custom model - user-imported model from HuggingFace, Spaces, etc.
    model: Any = None
    uuid: Any = None

GetCustomModelOutputPublic = ubx.DataSourceBinding(
