...
class AssociatedResourceStatus_Droplet:
...
@dataclasses.dataclass
class AssociatedResourceStatus_Resources:
...
@dataclasses.dataclass
class AssociatedResourceStatusConfig:
    droplet_id: Any = None

@dataclasses.dataclass
class AssociatedResourceStatusAttrs:
...
AssociatedResourceStatus = ubx.DataSourceBinding(
