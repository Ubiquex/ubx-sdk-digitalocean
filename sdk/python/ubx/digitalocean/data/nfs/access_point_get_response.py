...
class AccessPointGetResponse_AccessPoint_AccessPolicy:
...
@dataclasses.dataclass
class AccessPointGetResponse_AccessPoint:
...
@dataclasses.dataclass
class AccessPointGetResponseConfig:
    access_point_id: Any = None

@dataclasses.dataclass
class AccessPointGetResponseAttrs:
    # Represents an NFS access point resource.
    access_point: Any = None
    access_point_id: Any = None

AccessPointGetResponse = ubx.DataSourceBinding(
