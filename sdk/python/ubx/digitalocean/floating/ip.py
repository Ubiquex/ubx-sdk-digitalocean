...
class Ip_FloatingIp_Droplet_DiskInfo_Size:
    amount: Any = None
    unit: Any = None

@dataclasses.dataclass
class Ip_FloatingIp_Droplet_DiskInfo:
    size: Any = None
    type: Any = None

@dataclasses.dataclass
class Ip_FloatingIp_Droplet_GpuInfo:
    count: Any = None
    model: Any = None
    vram: Any = None

@dataclasses.dataclass
class Ip_FloatingIp_Droplet_Image:
    created_at: Any = None
...
@dataclasses.dataclass
class Ip_FloatingIp_Droplet_Kernel:
    id: Any = None
    name: Any = None
    version: Any = None

@dataclasses.dataclass
class Ip_FloatingIp_Droplet_Networks_V4:
    gateway: Any = None
    ip_address: Any = None
    netmask: Any = None
    type: Any = None
...
@dataclasses.dataclass
class Ip_FloatingIp_Droplet_Networks_V6:
    gateway: Any = None
    ip_address: Any = None
    netmask: Any = None
    type: Any = None
...
@dataclasses.dataclass
class Ip_FloatingIp_Droplet_Networks:
    v4: Any = None
    v6: Any = None

@dataclasses.dataclass
class Ip_FloatingIp_Droplet_NextBackupWindow:
    end: Any = None
    start: Any = None

@dataclasses.dataclass
class Ip_FloatingIp_Droplet_Region:
    available: Any = None
    features: Any = None
    name: Any = None
    sizes: Any = None
...
@dataclasses.dataclass
class Ip_FloatingIp_Droplet_Size:
    available: Any = None
    description: Any = None
    disk: Any = None
    disk_info: Any = None
