...
class VectordbGetVectorDbresponse_VectorDb_Config:
...
@dataclasses.dataclass
class VectordbGetVectorDbresponse_VectorDb_Endpoints:
...
@dataclasses.dataclass
class VectordbGetVectorDbresponse_VectorDb:
...
@dataclasses.dataclass
class VectordbGetVectorDbresponseConfig:
...
@dataclasses.dataclass
class VectordbGetVectorDbresponseAttrs:
    # Required. Human-readable name for the database.
    name: Any = None
    # Required. ID of the project to create the vector database in.
    project_id: Any = None
...
VectordbGetVectorDbresponse = ubx.ResourceBinding(
