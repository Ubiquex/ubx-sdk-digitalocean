...
class NatGateway_VpcNatGateway_Egresses_PublicGateways:
    ipv4: Any = None

@dataclasses.dataclass
class NatGateway_VpcNatGateway_Egresses:
    # An array of public gateway IP addresses for the VPC NAT gateway.
    public_gateways: Any = None

@dataclasses.dataclass
class NatGateway_VpcNatGateway_Vpcs:
    gateway_ip: Any = None
    vpc_uuid: Any = None

@dataclasses.dataclass
class NatGateway_VpcNatGateway:
...
@dataclasses.dataclass
class NatGateway_Vpcs:
    default_gateway: Any = None
    vpc_uuid: Any = None

_NatGateway_VpcsFields = {
