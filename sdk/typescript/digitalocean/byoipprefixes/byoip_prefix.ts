...
export interface ByoipPrefix_ByoipPrefix_Validations {
  name?: string | Computed<string>;
  note?: string | Computed<string>;
  status?: string | Computed<string>;
}

export interface ByoipPrefix_ByoipPrefix {
  ...
  validations?: ByoipPrefix_ByoipPrefix_Validations[] | Computed<ByoipPrefix_ByoipPrefix_Validations[]>;
}
...
export const ByoipPrefix: ResourceBinding<ByoipPrefixConfig, ByoipPrefixAttrs> = {
