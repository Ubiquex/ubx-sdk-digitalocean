...
export interface GetScheduledIndexingOutput_IndexingInfo {
...
export interface GetScheduledIndexingOutputConfig {
  knowledgeBaseUuid: string | Computed<string>;
}

export interface GetScheduledIndexingOutputAttrs {
  /** Metadata for scheduled indexing entries */
  indexingInfo: GetScheduledIndexingOutput_IndexingInfo;
  knowledgeBaseUuid: string;
}

export const GetScheduledIndexingOutput: DataSourceBinding<GetScheduledIndexingOutputConfig, GetScheduledIndexingOutputAttrs> = {
