...
export interface ApiGetCustomModelOutputPublic_Model_ActiveDeployments_Endpoints {
  privateEndpointFqdn?: string | Computed<string>;
  publicEndpointFqdn?: string | Computed<string>;
}

export interface ApiGetCustomModelOutputPublic_Model_ActiveDeployments {
  createdAt?: string | Computed<string>;
  endpoints?: ApiGetCustomModelOutputPublic_Model_ActiveDeployments_Endpoints | Computed<ApiGetCustomModelOutputPublic_Model_ActiveDeployments_Endpoints>;
...
export interface ApiGetCustomModelOutputPublic_Model_SourceRef {
...
export interface ApiGetCustomModelOutputPublic_Model_Tags {
  /** List of tag strings */
  tags?: string[] | Computed<string[]>;
}

export interface ApiGetCustomModelOutputPublic_Model {
  /** List of active deployments using this model */
  activeDeployments?: ApiGetCustomModelOutputPublic_Model_ActiveDeployments[] | Computed<ApiGetCustomModelOutputPublic_Model_ActiveDeployments[]>;
  ...
  sourceRef?: ApiGetCustomModelOutputPublic_Model_SourceRef | Computed<ApiGetCustomModelOutputPublic_Model_SourceRef>;
  ...
  tags?: ApiGetCustomModelOutputPublic_Model_Tags | Computed<ApiGetCustomModelOutputPublic_Model_Tags>;
...
export interface ApiGetCustomModelOutputPublicConfig {
  uuid: string | Computed<string>;
}

export interface ApiGetCustomModelOutputPublicAttrs {
  /** Custom model - user-imported model from HuggingFace, Spaces, etc. */
  model: ApiGetCustomModelOutputPublic_Model;
  uuid: string;
}

export const ApiGetCustomModelOutputPublic: DataSourceBinding<ApiGetCustomModelOutputPublicConfig, ApiGetCustomModelOutputPublicAttrs> = {
