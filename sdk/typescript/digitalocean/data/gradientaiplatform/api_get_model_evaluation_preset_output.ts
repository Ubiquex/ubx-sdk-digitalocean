...
export interface ApiGetModelEvaluationPresetOutput_Preset_CandidateInferenceConfig {
...
export interface ApiGetModelEvaluationPresetOutput_Preset_Metrics_AssociatedPresets {
  evalPresetUuid?: string | Computed<string>;
  name?: string | Computed<string>;
}

export interface ApiGetModelEvaluationPresetOutput_Preset_Metrics_CustomEvalConfig {
...
export interface ApiGetModelEvaluationPresetOutput_Preset_Metrics {
  associatedPresets?: ApiGetModelEvaluationPresetOutput_Preset_Metrics_AssociatedPresets[] | Computed<ApiGetModelEvaluationPresetOutput_Preset_Metrics_AssociatedPresets[]>;
  category?: string | Computed<string>;
  customEvalConfig?: ApiGetModelEvaluationPresetOutput_Preset_Metrics_CustomEvalConfig | Computed<ApiGetModelEvaluationPresetOutput_Preset_Metrics_CustomEvalConfig>;
...
export interface ApiGetModelEvaluationPresetOutput_Preset_StarMetric {
  metricUuid?: string | Computed<string>;
  name?: string | Computed<string>;
...
export interface ApiGetModelEvaluationPresetOutput_Preset {
  /** Inference configuration for the candidate model during evaluation. */
  candidateInferenceConfig?: ApiGetModelEvaluationPresetOutput_Preset_CandidateInferenceConfig | Computed<ApiGetModelEvaluationPresetOutput_Preset_CandidateInferenceConfig>;
  ...
  metrics?: ApiGetModelEvaluationPresetOutput_Preset_Metrics[] | Computed<ApiGetModelEvaluationPresetOutput_Preset_Metrics[]>;
  ...
  starMetric?: ApiGetModelEvaluationPresetOutput_Preset_StarMetric | Computed<ApiGetModelEvaluationPresetOutput_Preset_StarMetric>;
}

export interface ApiGetModelEvaluationPresetOutputConfig {
  evalPresetUuid: string | Computed<string>;
}

export interface ApiGetModelEvaluationPresetOutputAttrs {
  ...
  preset: ApiGetModelEvaluationPresetOutput_Preset;
}

export const ApiGetModelEvaluationPresetOutput: DataSourceBinding<ApiGetModelEvaluationPresetOutputConfig, ApiGetModelEvaluationPresetOutputAttrs> = {
