...
export interface User_MysqlSettings {
...
export interface User_Settings_Acl {
  id?: string | Computed<string>;
  permission?: string | Computed<string>;
  topic?: string | Computed<string>;
}

export interface User_Settings_MongoUserSettings {
...
export interface User_Settings_OpensearchAcl {
...
export interface User_Settings {
  ...
  acl?: User_Settings_Acl[] | Computed<User_Settings_Acl[]>;
  /** MongoDB-specific settings for the user. This option is not currently supported for other database engines. */
  mongoUserSettings?: User_Settings_MongoUserSettings | Computed<User_Settings_MongoUserSettings>;
  /** ACLs (Access Control Lists) specifying permissions on index within a OpenSearch cluster. */
  opensearchAcl?: User_Settings_OpensearchAcl[] | Computed<User_Settings_OpensearchAcl[]>;
...
export interface User_User {
  ...
  mysqlSettings?: User_MysqlSettings | Computed<User_MysqlSettings>;
  ...
  role?: string | Computed<string>;
  settings?: User_Settings | Computed<User_Settings>;
}

const User_MysqlSettingsFields: FieldMap = {
  authPlugin: "auth_plugin",
};

const User_Settings_AclFields: FieldMap = {
  id: "id",
  permission: "permission",
  topic: "topic",
};

const User_Settings_MongoUserSettingsFields: FieldMap = {
  databases: "databases",
  role: "role",
};

const User_Settings_OpensearchAclFields: FieldMap = {
  index: "index",
  permission: "permission",
};

const User_SettingsFields: FieldMap = {
  acl: {
    wireName: "acl",
    kind: "list",
...
export interface UserAttrs {
  ...
  /** Access key for TLS client authentication. (Kafka only) */
  accessKey: string;
  mysqlSettings: User_MysqlSettings;
  /** The name of a database user. */
  name: string;
  /** A randomly generated password for the database user.<br>Requires `database:view_credentials` scope. */
  password: string;
