...
export interface Tag_Resources_Databases {
  count?: number | Computed<number>;
  lastTaggedUri?: string | Computed<string>;
}

export interface Tag_Resources {
  count?: number | Computed<number>;
  databases?: Tag_Resources_Databases | Computed<Tag_Resources_Databases>;
  droplets?: Tag_Resources_Databases | Computed<Tag_Resources_Databases>;
  imgages?: Tag_Resources_Databases | Computed<Tag_Resources_Databases>;
  lastTaggedUri?: string | Computed<string>;
  volumeSnapshots?: Tag_Resources_Databases | Computed<Tag_Resources_Databases>;
  volumes?: Tag_Resources_Databases | Computed<Tag_Resources_Databases>;
}
...
export interface Tag_Tag {
  ...
  resources?: Tag_Resources | Computed<Tag_Resources>;
}
