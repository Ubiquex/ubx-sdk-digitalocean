...
type GetAgentOutput_Agent_AnthropicApiKey struct {
	// Key creation date
	CreatedAt any
...
type GetAgentOutput_Agent_ApiKeyInfos struct {
	CreatedAt any
	CreatedBy any
	DeletedAt any
	Name any
...
type GetAgentOutput_Agent_ApiKeys struct {
	ApiKey any
}

type GetAgentOutput_Agent_Chatbot struct {
	AllowedDomains any
...
type GetAgentOutput_Agent_ChatbotIdentifiers struct {
	AgentChatbotIdentifier any
}

type GetAgentOutput_Agent_ChildAgents struct {
}

type GetAgentOutput_Agent_Deployment struct {
	// Creation date / time
	CreatedAt any
	// Name
	Name any
...
type GetAgentOutput_Agent_Functions struct {
	ApiKey any
	CreatedAt any
	CreatedBy any
	Description any
...
type GetAgentOutput_Agent_Guardrails struct {
	AgentUuid any
	CreatedAt any
	DefaultResponse any
	Description any
...
type GetAgentOutput_Agent_KnowledgeBases_LastIndexingJob_DataSourceJobs struct {
	CompletedAt any
	DataSourceUuid any
	ErrorDetails any
	ErrorMsg any
...
type GetAgentOutput_Agent_KnowledgeBases_LastIndexingJob struct {
...
type GetAgentOutput_Agent_KnowledgeBases_RerankingConfig struct {
	Enabled any
	Model any
}

type GetAgentOutput_Agent_KnowledgeBases struct {
	AddedToAgentAt any
	CreatedAt any
	DatabaseId any
...
type GetAgentOutput_Agent_LoggingConfig struct {
...
type GetAgentOutput_Agent_McpServers struct {
	AllowedTools any
	Authorization any
	Headers any
	ServerLabel any
...
type GetAgentOutput_Agent_Model_Agreement struct {
	Description any
	Name any
	Url any
	Uuid any
...
type GetAgentOutput_Agent_Model_Endpoints struct {
	Capabilities any
	Endpoint any
}

type GetAgentOutput_Agent_Model_Modalities struct {
	Input any
	Output any
}

type GetAgentOutput_Agent_Model_Settings struct {
	DefaultString any
	DefaultValue any
	Max any
	Min any
...
type GetAgentOutput_Agent_Model_Version struct {
...
type GetAgentOutput_Agent_Model struct {
...
type GetAgentOutput_Agent_ModelProviderKey struct {
	// API key ID
	ApiKeyUuid any
	// Key creation date
	CreatedAt any
...
type GetAgentOutput_Agent_ModelRouter_Config_Policies_CustomTask struct {
	Description any
	Name any
}

type GetAgentOutput_Agent_ModelRouter_Config_Policies_SelectionPolicy struct {
	Prefer any
}

type GetAgentOutput_Agent_ModelRouter_Config_Policies struct {
	CustomTask any
	Models any
	SelectionPolicy any
	TaskSlug any
...
type GetAgentOutput_Agent_ModelRouter_Config struct {
...
type GetAgentOutput_Agent_ModelRouter struct {
	Config any
	// Creation date / time
	CreatedAt any
	// Description
...
type GetAgentOutput_Agent_OpenaiApiKey struct {
	// Key creation date
	CreatedAt any
	// Created by user id from DO
	CreatedBy any
...
type GetAgentOutput_Agent_Template_Guardrails struct {
	Priority any
	Uuid any
}

type GetAgentOutput_Agent_Template struct {
...
type GetAgentOutput_Agent_Workspace_EvaluationTestCases_Dataset struct {
	CreatedAt any
	DatasetName any
	DatasetType any
	DatasetUuid any
...
type GetAgentOutput_Agent_Workspace_EvaluationTestCases_Metrics_AssociatedPresets struct {
	EvalPresetUuid any
	Name any
}

type GetAgentOutput_Agent_Workspace_EvaluationTestCases_Metrics_CustomEvalConfig struct {
	CreatedAt any
	DeletedAt any
...
type GetAgentOutput_Agent_Workspace_EvaluationTestCases_Metrics struct {
...
type GetAgentOutput_Agent_Workspace_EvaluationTestCases_StarMetric struct {
	MetricUuid any
	Name any
...
type GetAgentOutput_Agent_Workspace_EvaluationTestCases struct {
	ArchivedAt any
	CreatedAt any
...
type GetAgentOutput_Agent_Workspace struct {
	// Agents
	Agents any
	// Creation date
	CreatedAt any
...
type GetAgentOutput_Agent struct {
...
var GetAgentOutput_Agent_McpServersFields = ubx.FieldMap{
...
type GetAgentOutputConfig struct {
...
type GetAgentOutputAttrs struct {
	// An Agent
	Agent any
	// Optional Anthropic API key ID to use with Anthropic models
	AnthropicKeyUuid any
...
var GetAgentOutput = ubx.ResourceBinding{
