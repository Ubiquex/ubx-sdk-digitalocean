...
type VectordbGetVectorDbresponse_VectorDb_Config struct {
...
type VectordbGetVectorDbresponse_VectorDb_Endpoints struct {
...
type VectordbGetVectorDbresponse_VectorDb struct {
...
type VectordbGetVectorDbresponseConfig struct {
...
type VectordbGetVectorDbresponseAttrs struct {
	// Required. Human-readable name for the database.
	Name any
	// Required. ID of the project to create the vector database in.
	ProjectId any
...
var VectordbGetVectorDbresponse = ubx.ResourceBinding{
