...
type ClusterlintResults_Diagnostics_Object struct {
	Kind      any
	Name      any
	Namespace any
}

type ClusterlintResults_Diagnostics struct {
	CheckName any
	Message   any
	Object    any
	Severity  any
...
type ClusterlintResultsConfig struct {
	ClusterId any
	RunId     any
}

type ClusterlintResultsAttrs struct {
	ClusterId any
...
var ClusterlintResults = ubx.DataSourceBinding{
