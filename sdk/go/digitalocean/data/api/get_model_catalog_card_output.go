...
type GetModelCatalogCardOutput_Data_CodeSnippets struct {
	Curl any
	Javascript any
	Python any
	Sdk any
...
type GetModelCatalogCardOutput_Data_Modalities struct {
	Input any
	Output any
}

type GetModelCatalogCardOutput_Data_Pricing struct {
...
type GetModelCatalogCardOutput_Data_PricingDetail_Variants_ScaledPricing_Intervals struct {
	EndTime any
	Prices any
	StartTime any
}

type GetModelCatalogCardOutput_Data_PricingDetail_Variants_ScaledPricing struct {
	Intervals any
	MaxPrices any
	MinPrices any
}

type GetModelCatalogCardOutput_Data_PricingDetail_Variants struct {
	Currency any
	Label any
	Mode any
	Prices any
...
type GetModelCatalogCardOutput_Data_PricingDetail struct {
	// Each available pricing variant for the model.
	Variants any
}

type GetModelCatalogCardOutput_Data struct {
	Availability any
	// Badges for models
	Badges any
...
type GetModelCatalogCardOutputConfig struct {
	Id any
	ModelId any
}

type GetModelCatalogCardOutputAttrs struct {
...
var GetModelCatalogCardOutput = ubx.DataSourceBinding{
