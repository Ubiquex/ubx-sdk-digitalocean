...
type ApiGetModelEvaluationPresetOutput_Preset_CandidateInferenceConfig struct {
	MaxTokens    any
	StopToken    any
	SystemPrompt any
	Temperature  any
...
type ApiGetModelEvaluationPresetOutput_Preset_Metrics_AssociatedPresets struct {
	EvalPresetUuid any
	Name           any
}

type ApiGetModelEvaluationPresetOutput_Preset_Metrics_CustomEvalConfig struct {
	CreatedAt           any
	DeletedAt           any
...
type ApiGetModelEvaluationPresetOutput_Preset_Metrics struct {
...
type ApiGetModelEvaluationPresetOutput_Preset_StarMetric struct {
	MetricUuid any
	Name       any
...
type ApiGetModelEvaluationPresetOutput_Preset struct {
...
type ApiGetModelEvaluationPresetOutputConfig struct {
	EvalPresetUuid any
}

type ApiGetModelEvaluationPresetOutputAttrs struct {
	EvalPresetUuid any
...
var ApiGetModelEvaluationPresetOutput = ubx.DataSourceBinding{
