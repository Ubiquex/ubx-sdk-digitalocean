...
type ApiGetCustomModelOutputPublic_Model_ActiveDeployments_Endpoints struct {
	PrivateEndpointFqdn any
	PublicEndpointFqdn  any
}

type ApiGetCustomModelOutputPublic_Model_ActiveDeployments struct {
	CreatedAt  any
	Endpoints  any
	Id         any
	Name       any
...
type ApiGetCustomModelOutputPublic_Model_SourceRef struct {
...
type ApiGetCustomModelOutputPublic_Model_Tags struct {
	// List of tag strings
	Tags any
}

type ApiGetCustomModelOutputPublic_Model struct {
...
type ApiGetCustomModelOutputPublicConfig struct {
	Uuid any
}

type ApiGetCustomModelOutputPublicAttrs struct {
	// Custom model - user-imported model from HuggingFace, Spaces, etc.
	Model any
	Uuid  any
}

var ApiGetCustomModelOutputPublic = ubx.DataSourceBinding{
