...
type ResourceStatus_Droplet struct {
...
type ResourceStatus_Resources struct {
	FloatingIps any
	ReservedIps any
	Snapshots any
	VolumeSnapshots any
...
type ResourceStatusConfig struct {
	DropletId any
}

type ResourceStatusAttrs struct {
...
var ResourceStatus = ubx.DataSourceBinding{
