...
type PointGetResponse_AccessPoint_AccessPolicy struct {
...
type PointGetResponse_AccessPoint struct {
...
type PointGetResponseConfig struct {
	AccessPointId any
}

type PointGetResponseAttrs struct {
	// Represents an NFS access point resource.
	AccessPoint any
	AccessPointId any
}

var PointGetResponse = ubx.DataSourceBinding{
